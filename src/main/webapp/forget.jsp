        ...
        <div class="layadmin-user-login-main">
            ...
            <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <input type="password" name="userPassword" id="LAY-user-login-password" lay-verify="pass" placeholder="重置密码" class="layui-input">
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    <button class="layui-btn layui-btn-fluid" lay-submit lay-filter="LAY-user-reg-submit">确 认</button>
                </div>
                <div class="layui-trans layui-form-item layadmin-user-login-other">
                    <a href="index.jsp" class="layadmin-user-jump-change layadmin-link layui-hide-xs">登入</a>
                </div>
            </div>
        </div>
